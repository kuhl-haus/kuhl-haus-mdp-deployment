...
check_image_version "https://${MDL_SERVER_DOMAIN}/health" "${IMAGE_TAG}" 60 5 || SHOULD_EXIT_WITH_CODE=1
...
# curl https://mdl.example.com/health
# {
...
#         "connected":true,
#         "last_message_time":"2026-01-27T22:39:39.105361",
#         "messages_received":55359715,
#         "trades":0,
#         "aggregate":55359715,
#         "quotes":0,
#         "halts":0,
