...
if [ -z "${FDL_SERVER_DOMAIN}" ]; then
  echo "FDL_SERVER_DOMAIN environment variable is not set!"
  exit 1
fi
...
check_image_version "https://${FDL_SERVER_DOMAIN}/health" "${IMAGE_TAG}" 60 5 || SHOULD_EXIT_WITH_CODE=1
...
# curl https://fdl.example.com/health
# {
#     "status": "OK",
#     "container_image": "ghcr.io/kuhl-haus/kuhl-haus-fdl-server:0.1.0",
#     "image_version": "0.1.0"
# }
