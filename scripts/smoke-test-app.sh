...
check_image_version "https://${APP_DOMAIN}/healthz" "${IMAGE_TAG}" 60 5 || SHOULD_EXIT_WITH_CODE=1
run_test_cmd_with_retry 'curl -s -o /dev/null -w "%{http_code}" https://${APP_DOMAIN}/' '200' 3 5
run_test_cmd_with_retry 'curl -s -o /dev/null -w "%{http_code}" https://${APP_DOMAIN}/index/' '200' 1 1
...
# {
#   "container_image": "ghcr.io/kuhl-haus/kuhl-haus-mdp-app-server:0.1.4.dev1-2c68fe9",
#   "image_version": "0.1.4.dev1-2c68fe9",
#   "status": "OK",
